...
# Light, Vibrant & Interactive Color Palette (Zero Dark Backgrounds)
...
CARD_BORDER_ACCENT = RGBColor(254, 215, 170) # Soft Warm Terracotta Border
TEXT_HEAD = RGBColor(15, 23, 42)         # #0F172A Deep Slate 900
TEXT_BODY = RGBColor(51, 65, 85)         # #334155 Slate 700 (High Contrast)
...
LIGHT_GREEN_BG = RGBColor(236, 253, 245) # #ECFDF5 Soft Emerald Card Fill
LIGHT_AMBER_BG = RGBColor(254, 243, 199) # #FEF3C7 Soft Amber Card Fill
LIGHT_BLUE_BG = RGBColor(239, 246, 255)  # #EFF6FF Soft Blue Card Fill
LIGHT_RED_BG = RGBColor(254, 242, 242)   # #FEF2F2 Soft Red Card Fill
...
# ==============================================================================
# SLIDE 1: Cover Slide (Clean Light Interactive Dashboard Theme)
# ==============================================================================
slide1 = prs.slides.add_slide(blank_slide_layout)
set_slide_background(slide1)

# Left Column: White Floating Card
left_card = add_card(slide1, Inches(0.8), Inches(0.8), Inches(6.1), Inches(5.9), bg_color=CARD_BG, border_color=CARD_BORDER)

tb1 = slide1.shapes.add_textbox(Inches(1.1), Inches(1.05), Inches(5.5), Inches(5.4))
tf1 = tb1.text_frame
tf1.word_wrap = True
...
p = tf1.add_paragraph()
p.text = "Predicting rural Primary Health Centre medicine stockouts before climate surges hit — and orchestrating surplus-to-deficit redistributions through an autonomous Google AI multi-agent mesh."
p.font.size = Pt(12)
...
p = tf1.add_paragraph()
p.text = "Built 100% on Google Cloud: Gemini 3.5 • Google ADK • Vertex AI • GEE • STT v2"
p.font.size = Pt(10)
p.font.bold = True
p.font.color.rgb = EMERALD
...
if os.path.exists(IMG_HERO):
    add_card(slide1, Inches(7.1), Inches(0.8), Inches(5.4), Inches(5.9), bg_color=CARD_BG, border_color=CARD_BORDER)
    slide1.shapes.add_picture(IMG_HERO, Inches(7.2), Inches(0.9), Inches(5.2), Inches(5.7))

# ==============================================================================
# SLIDE 2: The Crisis & The Ground Reality (Interactive Metric HUD)
# ==============================================================================
slide2 = prs.slides.add_slide(blank_slide_layout)
set_slide_background(slide2)
add_header(slide2, "01 / PROBLEM & CRISIS", "India's Rural Medicine Stockouts vs. Climate Shocks", "Why traditional government supply chains collapse when environmental surges strike")

# Stat Card 1
stat1 = add_card(slide2, Inches(0.8), Inches(1.5), Inches(5.6), Inches(1.5), bg_color=CARD_BG, border_color=CARD_BORDER)
tb = slide2.shapes.add_textbox(Inches(1.0), Inches(1.6), Inches(5.2), Inches(1.3))
tf = tb.text_frame
tf.word_wrap = True
tf.paragraphs[0].text = "17% – 51% Medicine Availability"
tf.paragraphs[0].font.size = Pt(22)
tf.paragraphs[0].font.bold = True
tf.paragraphs[0].font.color.rgb = RED_ALERT
p = tf.add_paragraph()
...
# Stat Card 2
stat2 = add_card(slide2, Inches(0.8), Inches(3.2), Inches(5.6), Inches(1.6), bg_color=CARD_BG, border_color=CARD_BORDER)
tb = slide2.shapes.add_textbox(Inches(1.0), Inches(3.3), Inches(5.2), Inches(1.4))
tf = tb.text_frame
tf.word_wrap = True
tf.paragraphs[0].text = "+30% to +50% Climate Surge"
tf.paragraphs[0].font.size = Pt(22)
tf.paragraphs[0].font.bold = True
...
# Stat Card 3
stat3 = add_card(slide2, Inches(0.8), Inches(5.0), Inches(5.6), Inches(1.7), bg_color=CARD_BG, border_color=CARD_BORDER)
...
tf.paragraphs[0].font.bold = True
tf.paragraphs[0].font.color.rgb = TEXT_HEAD
p = tf.add_paragraph()
...
# Right: Problem Photo in Clean White Frame
if os.path.exists(IMG_SMOG):
    ...
    p.text = "SYSTEMIC BOTTLENECK: State portals (e-Aushadhi / DVDMS) use backward-looking 30-day paper indents with zero climate early-warning integration."
    p.font.size = Pt(11)
    p.font.bold = True
    p.font.color.rgb = TERRACOTTA
...
add_header(slide3, "02 / THE SOLUTION", "The Causal Resilience Loop", "Connecting satellite atmospheric telemetry to frontline rural clinics in 5 automated steps")

steps = [
    ("1. SENSE", "Google Earth Engine", "Ingests Sentinel-5P AOD, PM2.5, wind speed & INSAT-3DR thermal inversion traps across rural corridors.", BLUE_ACCENT),
    ...
    ("5. GOVERN", "Official Dispatch", "1-click CMO approval generates official government challans with SHA-256 cryptographic seal.", TEXT_HEAD),
]
...
banner = add_card(slide3, Inches(0.8), Inches(6.3), Inches(11.7), Inches(0.7), bg_color=LIGHT_GREEN_BG, border_color=EMERALD)
...
agents = [
    ("🛰️ Environmental Sentinel Agent", "Monitors Google Earth Engine Sentinel-5P AOD, PM2.5 plumes & NASA FIRMS thermal fire clusters to detect inversion traps.", BLUE_ACCENT),
...
# ==============================================================================
# SLIDE 5: Google Cloud & AI Ecosystem Tools Slide (Light Interactive Grid)
# ==============================================================================
...
g_badge = add_card(slide5, Inches(0.8), Inches(6.85), Inches(11.7), Inches(0.45), bg_color=LIGHT_GREEN_BG, border_color=EMERALD)
...
# ==============================================================================
# SLIDE 6: Mathematical Foundation & Optimization
# ==============================================================================
...
metrics = [
    ...
    ("100% DPDP 2023 Compliant", "Zero Patient PII handled. All movements cryptographically chained under SHA-256 for non-repudiation.", BLUE_ACCENT)
]
...
if os.path.exists(IMG_IMPACT):
    add_card(slide8, Inches(6.7), Inches(1.5), Inches(5.8), Inches(5.4), bg_color=CARD_BG, border_color=CARD_BORDER)
...
# Save presentation
prs.save(PPTX_PATH)
print(f"SUCCESS: Saved updated 9-slide Light Presentation to {PPTX_PATH}")
